...
export const LANGUAGE_META: Record<string, LanguageMeta> = {
  ...
  cs: { endonym: "Čeština", name: "Czech", regions: "Czech Republic", dir: "ltr" },
  de: { endonym: "Deutsch", name: "German", regions: "Germany, Austria, Switzerland", dir: "ltr" },
  es: { endonym: "Español", name: "Spanish", regions: "Spain, Latin America", dir: "ltr" },
  fr: { endonym: "Français", name: "French", regions: "France, Canada, Belgium, Switzerland", dir: "ltr" },
  hi: { endonym: "हिन्दी", name: "Hindi", regions: "India", dir: "ltr" },
  id: { endonym: "Bahasa Indonesia", name: "Indonesian", regions: "Indonesia", dir: "ltr", noPlurals: true },
  it: { endonym: "Italiano", name: "Italian", regions: "Italy, Switzerland", dir: "ltr" },
  ...
  pl: { endonym: "Polski", name: "Polish", regions: "Poland", dir: "ltr" },
  "pt-br": { endonym: "Português", name: "Portuguese (Brazil)", regions: "Brazil", dir: "ltr" },
  ru: { endonym: "Русский", name: "Russian", regions: "Russia, Central Asia", dir: "ltr" },
  sw: { endonym: "Kiswahili", name: "Swahili", regions: "Kenya, Tanzania, Uganda", dir: "ltr" },
  ...
  tr: { endonym: "Türkçe", name: "Turkish", regions: "Türkiye, Cyprus", dir: "ltr" },
  uk: { endonym: "Українська", name: "Ukrainian", regions: "Ukraine", dir: "ltr" },
  ur: { endonym: "اردو", name: "Urdu", regions: "Pakistan, India", dir: "rtl" },
  vi: { endonym: "Tiếng Việt", name: "Vietnamese", regions: "Vietnam", dir: "ltr", noPlurals: true },
